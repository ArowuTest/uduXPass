    ...
    <div className="min-h-screen bg-gradient-to-br from-red-500 to-red-600 flex flex-col items-center justify-center p-6 text-white">
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-lg text-red-600">{message}</p>
            </div>
          </div>
      ...
      <div className="w-full max-w-md space-y-3 mt-8">
        ...
        <Button
          ...
          className="w-full h-14 text-base font-semibold bg-white text-red-600 hover:bg-red-50 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400"
        >
          Scan Next Ticket
        </Button>
      </div>
